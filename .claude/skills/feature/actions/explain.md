...
3. For each file created or modified:
   ...
   - Highlight any key functions, and which layer it belongs to
     (handler/service/repository/schema/types)
...
Brief summary of the request → handler → service → repository → DB flow.
